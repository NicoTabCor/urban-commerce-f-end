import { Form, NavLink, redirect, useActionData, useNavigation, useSubmit } from 'react-router-dom';
...
export default function Login() {
	...
	const loginGoogle = async (token) => {
		...
		oculto.value = token.credentials;
	...
	return (
		<div className="formulario">
			...
			<Form id='form-google' action="/user/login" method="post">
				<GoogleLogin
